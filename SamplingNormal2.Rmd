---
title: Stichprobenverteilug einer Normalverteilung und Intervalschätzung für den
  Mittelwert
output: pdf_document
---
...
## Realistischer Fall: Konfidenzinterval wenn $\sigma$ unbekannt ist
...
Wie schon erwähnt diese Verteilung ist N(mu, 1 ) verteilt. Das ist gut, vorausgesetzt wir haben 
$\sigma$. Wenn nicht, können wir die berechnete Standardabweichung S aus den Daten verwenden. 
Wir hoffen, dass 
...
irgendwelche bekannte Verteilung folgt.Zuerst überlegen wir uns. Weil S nicht ganz gleich $\sigma$
ist, sondern eine Schätzung mit Fehler, erwarten wir, dass unsere Schätzung von $\mu$ jetzt
unpräziser wird.
...
```
Die rechte Verteilung ist die t-Verteilung (auch bekannt als Studentverteilung).
Für eine niedrige Anzahl Freiheitsgraden ist die Studentverteilung breiter als die Normalverteilung.
Sobald die Anzahl Freiheitsgraden (sprich die Stichprobegrösse) steigt, nähert sich die
Studentverteilung die Standardnormalverteilung an.
...
und das Konfidenzinterval wird folgendermassen berechnet:

$$
\mu = \bar{X} \pm t_{\frac{a}{2}, df} \frac{S}{\sqrt{n}} 
$$
wobei df = n -1
...
Vergleichen wir zum Konfidenzinterval, wenn wir statt S = 2, einen bekannten $\sigma$ = 2
haben.
